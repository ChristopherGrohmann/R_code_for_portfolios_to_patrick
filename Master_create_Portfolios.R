...
hh$Other = hh$Other/hh$anzahl_transactionen
...
setkey(transactions, user_id)
hhy$anzahl_transactionen = transactions[,.(anzahl_transactionen =length(transaction_id)),by=.(user_id,year= year(date))]$anzahl_transactionen
...
hhy$Other = hhy$anzahl_transactionen-hhy$Stock -hhy$Bond-hhy$Fund-hhy$Warrents- hhy$Certificate
